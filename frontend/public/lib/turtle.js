/**
 * Javascript library for drawing with a turtle on a canvas.
 * @author Artak Kolyan
 * @link   https://hanumanum.github.io/js-turtle/index_en.html
 */
...
(function () {
  ...
  function draw() {
    ...
    if (turtle.visible) {
      ...
      turtleContext.fillStyle = "#319A62";
      turtleContext.fill();
      turtleContext.fillStyle = "#54C791";
      const legOffsets = [
        { dx: -bodyWidth / 2 + 2, dy: -bodyHeight / 2 + 4 }, // Lewa przednia
        { dx: bodyWidth / 2 - 2, dy: -bodyHeight / 2 + 4 }, // Prawa przednia
        { dx: -bodyWidth / 2 + 2, dy: bodyHeight / 2 - 4 }, // Lewa tylna
        { dx: bodyWidth / 2 - 2, dy: bodyHeight / 2 - 4 }, // Prawa tylna
      ];
